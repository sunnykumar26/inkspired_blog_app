  ...
  return (
    ...
    <div className="w-full flex justify-center items-center h-[80vh] ">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
         ...
         <input onChange={(e)=>setUsername(e.target.value)} className="w-full px-4 py-2 outline-0 bg-gray-200" type="text" placeholder="Enter your username" />
         <input onChange={(e)=>setEmail(e.target.value)}    className="w-full px-4 py-2 outline-0 bg-gray-200" type="text" placeholder="Enter your email" />
         <input onChange={(e)=>setPassword(e.target.value)} className="w-full px-4 py-2 outline-0 bg-gray-200" type="password" placeholder="Enter your password" />
